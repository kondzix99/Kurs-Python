...
Cake.export_1_cake_to_html(cake01, path=r"C:\Users\konra\OneDrive\Dokumenty\Konrad Pliki\Kurs-Python\Kurs Python Pliki\export_static.html")

print('Class------'*10)
Cake.export_all_cakes_to_html= types.MethodType(export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html(path=r"C:\Users\konra\OneDrive\Dokumenty\Konrad Pliki\Kurs-Python\Kurs Python Pliki\export_class.html")
...
for c in Cake.bakery_offer:
    c.export_this_cake_to_html(r"C:\Users\konra\OneDrive\Dokumenty\Konrad Pliki\Kurs-Python\Kurs Python Pliki\{}.html".format(c.name.replace(' ', '_')))
