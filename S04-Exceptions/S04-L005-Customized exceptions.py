...
#klasa głowna exception
class TripException(Exception):
    def __init__(self, text, description):
        super().__init__(text) #text przekazany z klasy rodzicielskiej Exception
        self.description = description

    def __str__(self):
       return "{}, info: {}".format(super().__str__(), self.description)

#klasa odpowiadajacy za obsluge bledow zwiazanych z nazwa
...
#klasa odpowiadajaca za obsluge bledow zwiazany z data startowa i koncowa
